...
function md000200_parse_request( &$wp ) {
    ...
    if(($wp->request == 'md000200') ) {
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div style="text-align: center;"><h4><strong>ASSOCIADOS</strong></h4></div>
            </div>
            <div class="col-md-2">
        ...
        <?php echo do_shortcode('[scm_text on_op="view"]<div style="text-align:center;background-color:silver;padding:20px;margin:20px;">APORTES</div>[/scm_text]') ?>
        <?php echo do_shortcode('[scm_list md=000230 on_op="view" criterio="md000230_associado=__cod__" ]') ?>
        </div>
        </div>
        <?php 
        // smc_bot();
